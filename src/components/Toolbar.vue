  ...
  <nav>
    <v-toolbar flat dark fixed>
      ...
      <v-toolbar-title class="text-uppercase grey--text">
        <span class="font-weight-light-uppercase white--text">D</span>
        <span>K</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>

      <v-toolbar-items class="hidden-sm-and-down">
        <v-btn flat color="grey" router to="/">Beranda</v-btn>
        <v-btn flat color="grey" router to="/certifications">Sertifikat</v-btn>        
        <v-btn flat color="grey" router to="/about">Tentang</v-btn>
      </v-toolbar-items>
    </v-toolbar>
  ...
  data() {
    return {
      ...
      pages: [
        ...
        { icon: "insert_comment", text: "About", route: "/about" }
      ]
    };
  }
};
